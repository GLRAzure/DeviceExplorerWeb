...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <br />
        <asp:TextBox ID="txtConnectionString" runat="server" Height="63px" Rows="2" TextMode="MultiLine" Width="629px"></asp:TextBox>&nbsp; <asp:Button ID="cmdUpdate" runat="server" Text="Show Devices" OnClick="cmdUpdate_Click" />
        <br />
        <br />
